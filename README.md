...
2. **Storage Layer:** A thread-safe **CInvertedIndex** protected by `std::shared_mutex` to allow concurrent reads and serialized writes and optimized binary I/O for persistent storage.
